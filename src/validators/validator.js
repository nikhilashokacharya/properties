...
export const validators = {
  ...
  sizeValidate: function (e, selectedUserForm, updateProperty) {
    ...
    if (updateProperty === "top" || updateProperty === "left") {
      if (parseInt(e.target.value) > -9830 && length <= 8) {
        ...
        return {showDialog:true,message:"overflow"};
      }
    }
  ...
  imageValidate: function (e, selectedUserForm, updatedProperty) {
    debugger;
  ...
  imageValidateForControls: function (e, selectedUserFormControls, updatedProperty) {
    debugger;
    let srcChunks = e.target.value.split(".");
    let fileExtension = srcChunks[srcChunks.length - 1].toLowerCase();
    let files = e.target.files[0];
  ...
  scrollValidate: function (e, selectedUserForm, updateProperty) {
    debugger;
